...
cuya base mide lo mismo que uno de los lados del cuadrado, y un rectángulo cuyo ancho mide lo mismo que uno de los lados del cuadrado, 
...
el área de un cuadrado se calcula elevando al cuadrado la medida de uno de sus lados.
...
public class AreaDelPoligono_9 {
    ...
    public static void main(String[] args) {
        double ladoCuadrado, areaCuadrado, alturaTriangulo, areaTriangulo, areaTotal;
        ...
        /*
        Se multiplica por 5 el area del Triangulo ya que el Rectangulo esta compuesto por 2 TriangulosRectangulos
        Y de esta manera optimizamos el codigo
         */
    }
}