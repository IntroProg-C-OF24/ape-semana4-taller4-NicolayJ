...
public class PagoDePrestamo_6 {

    public static void main(String[] args) {
        double montoDePrestamo, interesMensual, interesAnual, tasaInteres, plazoEnMeses, pagoMensual;
        ...
        plazoEnMeses = 12;
        pagoMensual = (montoDePrestamo * tasaInteres) / (1 - Math.pow(1 + tasaInteres, -plazoEnMeses));
