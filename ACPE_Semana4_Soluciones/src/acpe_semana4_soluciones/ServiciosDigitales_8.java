...
public class ServiciosDigitales_8 {
    ...
    public static void main(String[] args) {
        double mensualidadNetflix, mensualidadYoutubePremium, mensualidadDropbox, mensualidadSpotify, costoTotalMensual;
        Scanner teclado = new Scanner(System.in);
        System.out.println("Ingresar el costo de la mensualidad de Netflix: ");
        mensualidadNetflix = teclado.nextDouble();
        System.out.println("Ingresar el costo de la mensualidad de Youtube Premium: ");
        ...
        costoTotalMensual = mensualidadNetflix + mensualidadYoutubePremium + mensualidadDropbox + mensualidadSpotify;
        System.out.print("Ingrese su edad: ");
        int edad = teclado.nextInt();
        if (edad < 30) {
            costoTotalMensual *= 0.8;
            System.out.println("Se aplico un descuento del 20% por ser menor de 30 anios.");
        }
        System.out.println("El valor total a pagar mensual por servicios digitales es: " + costoTotalMensual);
    }
}